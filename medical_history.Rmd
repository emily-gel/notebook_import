...
1. Using the LabKey API find all admissions in the hes_apc table for the participant ID 111000328. Get the dates of admission and discharge, all diagnoses and all operations.
